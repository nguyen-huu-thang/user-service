...
public final class IdService {
    ...
    private static final int ID_LENGTH = 24;        // 192-bit
    private static final int BASE62_LENGTH = 33;    // fixed max length (correct)
    ...
    private static String encodeBase62(byte[] input) {
        ...
        char[] buffer = new char[64]; // tăng buffer để chắc chắn đủ cho 192-bit
